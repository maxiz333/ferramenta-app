...
function _doCartSearch(){
  ...
  rows.forEach(function(r,i){
    ...
    var m=magazzino[i]||{};
    // Early-exit rapido con indexOf prima del fuzzyScore (pi- veloce su 14k articoli)
    var text=[r.desc,r.codF,r.codM,m.marca,m.specs].join(' ');
    if(text.toLowerCase().indexOf(qLow)<0 && !r.codF.startsWith(q) && !r.codM.startsWith(q)) return;
