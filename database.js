...
var DEF=[
  {data:"04-03-2026",desc:"Catenacci traverso T/Normale acciaio zincato 160mm",codF:"24040-16/7",codM:"8032817021734",prezzoOld:"",prezzo:"3,20",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Cassette p/lettere Inox Lettera-Big Italia 22x7,5x32H",codF:"27265-10/9",codM:"7373013",prezzoOld:"",prezzo:"31,90",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Nastro isolante Boston Bianco 25 Metri",codF:"32635-06/5",codM:"1632017",prezzoOld:"",prezzo:"2,00",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Nastro maschera Boston Maskera Profess 50M H.30mm",codF:"32683-30/1",codM:"1632021",prezzoOld:"",prezzo:"2,40",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Shampoo autovetture Rhutten Concentrato 1000ml",codF:"33320-10/6",codM:"6557007",prezzoOld:"",prezzo:"2,90",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Fascette p/cablaggi Hufirma Nylon 100pz 7,5x550mm",codF:"35100-88/1",codM:"0318062",prezzoOld:"",prezzo:"17,00",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Placche alluminio tipo Magic Oro due fori Art.8702",codF:"35120-45/2",codM:"2106045",prezzoOld:"",prezzo:"7,60",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Tubo corrugato PVC nero Rotolo 100M Dia.20mm",codF:"35141-20/4",codM:"2106026",prezzoOld:"",prezzo:"7,00",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Fustelle alfa a cavallotto Acciaio vern.rosse Dia.10mm",codF:"37152-10/9",codM:"1573007",prezzoOld:"",prezzo:"10,40",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Inserti portabussole Vigor Magnetico 3 pezzi 50mm",codF:"38494-03/1",codM:"1588073",prezzoOld:"",prezzo:"3,00",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Scovoli ad elica doppia Vigor Att.filettato 12Ma 120mm",codF:"40830-90/2",codM:"1707018",prezzoOld:"",prezzo:"5,00",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Decespugliatori Vigor DE-1000 Diritto 1000W",codF:"44510-16/9",codM:"3030014",prezzoOld:"",prezzo:"49,00",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Decespugliatori Vigor VDE-52",codF:"44620-10/3",codM:"3040024",prezzoOld:"",prezzo:"139,00",size:"large",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Mascherine protettive Italia ITL4 FFP2 NR",codF:"54462-06/9",codM:"1013008",prezzoOld:"",prezzo:"0,70",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Elettrodi Hufirma HU-41 Rutilici SC.PZ.250 2,5x300mm",codF:"54600-25/6",codM:"2440054",prezzoOld:"",prezzo:"23,00",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Compressori Vigor 220V VCA-24L 1Cil/Dir 2HP",codF:"56350-12/8",codM:"4115007",prezzoOld:"",prezzo:"102,00",size:"large",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Ingrassatori a leva Vigor Cartucce D.56x300mm 1000G",codF:"57835-40/2",codM:"1586008",prezzoOld:"",prezzo:"19,50",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Carriole Vigor 100-Verde Vasca verde plastic 100L",codF:"59730-10/1",codM:"3436010",prezzoOld:"",prezzo:"43,00",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Carriole Vigor 100-Gialla Vasca gialla plastic 100L",codF:"59730-20/0",codM:"3436003",prezzoOld:"",prezzo:"45,00",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Scale Facal Stilo EN131 3 Rampe 7+7+7 Grad. 2,02-4,26",codF:"59846-10/9",codM:"2835001",prezzoOld:"",prezzo:"145,00",size:"large",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Spingiacqua zincati asta gomma morsetto 750mm",codF:"61210-30/1",codM:"2844003",prezzoOld:"",prezzo:"7,80",size:"small",note:"",giornalino:""},
  {data:"04-03-2026",desc:"Picconi forgiati Extra Vigor punta/penna 1500G",codF:"61840-10/2",codM:"2813008",prezzoOld:"",prezzo:"10,50",size:"small",note:"",giornalino:""},
];
...
function init(){
  var saved=lsGet(SK,null);
  rows=(saved&&saved.length)?saved:DEF.map(function(r){return Object.assign({},r);});
  ...
  loadFatture();
  loadOrdFor();
  // Avvia sull'inventario - non aprire popup automatici
  goTab('t0');
}
  ...
  if(header.indexOf('giornalino')>=0){
    ...
    function processChunk(){
      ...
      for(;idx<end;idx++){
        ...
        pendingImportDB.push({desc:nome,codF:codF,codM:codM,qty:qty,pa:pa,pv:pv,giornalino:giorn});
        if(giorn==='si'||giorn==='s-'){
...
function renderInventario(){
  ...
  rows.forEach(function(r,i){
    ...
    var haystack=[r.desc,r.codF,r.codM,m.marca,m.specs].join(' ');
...
function renderMagazzino(){
  ...
  rows.forEach(function(r,i){
    ...
    if(search){
      if(magMode==='prod'){
        // Cerca in descrizione + codici
        var haystack=[r.desc,r.codF,r.codM,m.marca].join(' ');
